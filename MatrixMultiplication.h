...
A_Matrix2x3 operator *(A_Matrix2x3 _AM23, A_Matrix3x3 _AM33) {
	...
	T_CurrentOperation += _AM23.GetDemensionAtAddress(2) * _AM33.GetDemensionAtAddress(8);
	...
	T_CurrentOperation += _AM23.GetDemensionAtAddress(5) * _AM33.GetDemensionAtAddress(8);
...
A_Matrix2x4 operator *(A_Matrix2x4 _AM24, A_Matrix4x4 _AM44) {
	...
	T_CurrentOperation += _AM24.GetDemensionAtAddress(2) * _AM44.GetDemensionAtAddress(11);
	...
	T_CurrentOperation += _AM24.GetDemensionAtAddress(6) * _AM44.GetDemensionAtAddress(11);
...
A_Matrix4x3 operator *(A_Matrix4x2 _AM42, A_Matrix2x3 _AM23) {
	...
	//working out T_Result[2]
	T_CurrentOperation = _AM42.GetDemensionAtAddress(0) * _AM23.GetDemensionAtAddress(2);
	T_CurrentOperation += _AM42.GetDemensionAtAddress(1) * _AM23.GetDemensionAtAddress(5);
	...
	//working out T_Result[5]
	T_CurrentOperation = _AM42.GetDemensionAtAddress(2) * _AM23.GetDemensionAtAddress(2);
	T_CurrentOperation += _AM42.GetDemensionAtAddress(3) * _AM23.GetDemensionAtAddress(5);
	...
	//working out T_Result[8
	T_CurrentOperation = _AM42.GetDemensionAtAddress(4) * _AM23.GetDemensionAtAddress(2);
	T_CurrentOperation += _AM42.GetDemensionAtAddress(5) * _AM23.GetDemensionAtAddress(5);
	...
	//working out T_Result[11]
	T_CurrentOperation = _AM42.GetDemensionAtAddress(6) * _AM23.GetDemensionAtAddress(2);
	T_CurrentOperation += _AM42.GetDemensionAtAddress(7) * _AM23.GetDemensionAtAddress(5);
